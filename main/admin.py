...
class MatchesAdmin(admin.ModelAdmin):
    list_display = ('left_team', 'right_team', 'winner_team', 'looser_team', 'man_of_the_match', 'bowler_of_the_match')
    readonly_fields = ('left_team', 'right_team', 'winner_team',  'looser_team', 'man_of_the_match', 'bowler_of_the_match')
