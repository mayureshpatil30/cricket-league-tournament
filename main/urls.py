...
from main.views import TeamListView, TeamDetailView, PlayerDetailView, MatchesListView, MatchUpdateView,\
    PointsListView
...
urlpatterns = [
    ...
    path('player/<int:pk>/details', PlayerDetailView.as_view(), name="player_details" ),
